...
export const coding = {
  ...
  points: [
    ...
    "Python Data Science -  ML, AI And Power BI",
  ],
};
...
export const digitalCourses = [
  { id: 1, name: "Advanced digital marketing", months: "5 Months" },
  { id: 2, name: "Basic digital marketing", months: "2 Months" },
];
...
export const multimediaCourses = [
  { id: 1, name: "Graphic Design", months: "4 Months" },
  { id: 2, name: "UI/UX Design", months: "3 Months" },
  { id: 3, name: "Production & Post production", months: "3 Months" },
